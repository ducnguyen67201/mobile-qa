...
} satisfies AppResponse['readiness']
export const app = {
  id: appId,
  organization_id: orgId,
  name: 'Synthetic app',
  android_package: 'com.example.synthetic',
  environment: {
    id: orgId,
    name: 'Staging',
    backend_origins: ['https://api.synthetic.test'],
    login_origins: [],
    revision: 1,
...
export const upload = {
  id: uploadId,
  app_id: appId,
  original_filename: 'synthetic.apk',
  expected_size: 4,
  actual_size: 4,
  state: 'uploaded',
  expires_at: '2099-09-12T09:00:00Z',
...
export const build = {
  ...
  validation: {
    ...
    validator_version: 'fixture-only',
    intake_policy_version: 'fixture-only',
  },
  metadata: {
...
export function apiError(status = 401) {
...
export const googleChallenge = {
  challenge_id: uploadId,
  client_id: 'synthetic.apps.googleusercontent.com',
  nonce: 'synthetic-nonce',
} satisfies GoogleLoginChallenge
