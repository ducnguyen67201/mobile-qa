...
pub struct WorkerContracts {
    pub build_delivery: crate::artifacts_api::BuildDelivery,
    pub hosts: crate::device_hosts::HostContracts,
    ...
    pub authoring_request: crate::automation::AuthoringModelEnvelope,
    pub model_definition: crate::model_registry::ModelDefinition,
    pub resolved_model: crate::model_registry::ResolvedModel,
    pub worker_model_capabilities: crate::model_registry::WorkerModelCapabilities,
