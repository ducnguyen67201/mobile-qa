...
Select the project/config assigned to Mobile QA. No project or config name is guessed
or committed; scoped selection lives in the CLI's user configuration. Existing CLI
