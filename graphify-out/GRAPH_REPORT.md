...
## Summary
- 2631 nodes · 7373 edges · 155 communities (109 shown, 29 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 560 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00521cdb`
...
8. `exec()` - 53 edges
9. `rows()` - 48 edges
10. `@tanstack/react-query` - 44 edges
...
- `qualify()` --uses--> `Profile`  [INFERRED]
  scripts/regression_acceptance.py → apps/mobile-worker/src/mobile_qa_worker/qualification/config.py
...
Cohesion: 0.05
Nodes (97): build(), claim(), detail(), open(), options(), ApiResult, AppContext, HeaderMap (+89 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (80): archive(), create(), default_plan(), draft(), entry(), list(), options(), ApiResult (+72 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (55): mocks, issue, attempt(), authentication, backendUnavailable, invalidPassword, options, plan (+47 more)
...
Cohesion: 0.04
Nodes (53): Owned Android operations, independent of app-specific qualification oracles., device_for(), execute(), png(), Path, Synthetic HTTP-worker evidence. It is never advertised as device qualification., Durable HTTP execution client; separate from the qualification experiment., Evidence (+45 more)
...
Cohesion: 0.05
Nodes (55): Parent-owned discovery effects. The SDK receives observations, never device…, main(), Explicit developer commands, not a long-running production worker. `fake` emits…, Verify the pinned SDK import seam without constructing its stateful Agent.…, sdk_import(), host_environment(), Client, NoRedirect (+47 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (46): cancelRun(), appQuery(), settingsQuery, AccountMenu(), ApkUpload(), AppForm(), parseOrigins(), AttemptReadiness() (+38 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (54): Sequential approved actions on the qualified demo adapter, with supervised SDK…, sdk_action(), Explicit bounded navigation; imports the SDK after process environment…, accepted(), backend(), owned_backend(), Path, qualify() (+46 more)
...
Cohesion: 0.07
Nodes (33): hierarchy(), AndroidDevice, assert_ports_available(), doctor(), Path, Own one disposable AVD. Refuse existing emulator-5554 rather than borrowing it., Prove we can listen, without treating a closed TCP connection as a live owner., Explicit app policies. Generic direct execution never uses the demo's backend… (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (42): checked(), buildsQuery(), archiveLibraryEntry(), createLibraryEntry(), defaultPlanQuery(), libraryDraftQuery(), libraryEntryQuery(), libraryErrorDetails() (+34 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (40): configure_agent(), bounded_model(), __call__(), direct_tool(), foreground(), observation(), perform_direct_action(), Any (+32 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (25): One-device operator qualification; no production scheduler or customer…, UsageRecorder, parametrize, test_campaign_oracle_never_reaches_runner(), run(), test_campaign_schedule_and_accounting(), test_full_supervisor_with_injected_device(), boot() (+17 more)
...
Cohesion: 0.13
Nodes (37): active_assignment(), advertise_execution(), advertise_phone(), eligible_models(), purpose_name(), register(), resolve(), resolve_for_new_work() (+29 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (35): caseRunPreviewQuery(), createCaseRun(), createSuiteRun(), suiteRunPreviewQuery(), buildQuery(), openPhone(), phoneOptionsQuery(), phoneQuery() (+27 more)

### Community 18 - "Community 18"
Cohesion: 0.14
Nodes (42): ActionKind, ApprovalPurpose, ArtifactReceipt, ArtifactRequest, AttemptResponse, CheckResult, ClaimRequest, ClaimResponse (+34 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (31): check(), execute(), nodes(), Execute one typed command on the owned serial. Mutating calls are never retried., Trial assertions use retained hierarchy properties, independently of AI prose., resolve(), Path, One sequence, shared device executor, durable per-step receipts. (+23 more)
...
Cohesion: 0.18
Nodes (33): build(), BuildQuery, claim(), cleanup(), complete(), events(), heartbeat(), legacy_receipt() (+25 more)

### Community 22 - "Community 22"
Cohesion: 0.14
Nodes (33): create(), manifest(), preview(), ApiResult, AppContext, ConnectionTrait, Uuid, create() (+25 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (27): DiscoveryBroker, explore(), Path, Bounded pipe protocol; SDK logging goes to /dev/null, never into public…, invoke(), Path, Bounded discovery drives the same direct commands testers record and rerun., Use the same pixel mask for retained evidence and provider requests. (+19 more)

### Community 24 - "Community 24"
Cohesion: 0.14
Nodes (25): createRun(), planQuery(), runsQuery(), forgetSession(), headers(), options, setCsrfToken(), completeUpload() (+17 more)
...
Cohesion: 0.14
Nodes (21): cancelTestGeneration(), generateTests(), saveAuthoredTests(), templatesQuery(), defaultJourneys, GenerationPanel(), ProposalReview(), session (+13 more)
...
Cohesion: 0.10
Nodes (17): historyQuery(), runQuery(), appsQuery(), labels, observed(), RunResult(), mocks, SessionResult() (+9 more)

### Community 31 - "Community 31"
Cohesion: 0.21
Nodes (23): rows(), ConnectionTrait, QueryResult, Vec, assemble(), attempt(), authorize(), cancel() (+15 more)
...
Cohesion: 0.24
Nodes (19): compare(), compares_verified_facts_and_freezes_baseline_identity(), context_matches(), coverage_changes_remain_visible(), eligible(), failed(), manifest_legacy_serialization_is_unchanged(), outcome() (+11 more)
...
Cohesion: 0.29
Nodes (19): exec(), claim(), claim_wait(), cleanup(), complete(), events(), heartbeat(), lease() (+11 more)
...
Cohesion: 0.25
Nodes (19): one(), action(), cancel(), command(), enqueue(), generate(), job_detail(), ApiResult (+11 more)
...
Cohesion: 0.22
Nodes (15): hash_valid(), QualificationArtifact, QualificationContracts, QualificationOutcome, QualificationRequest, QualificationReset, QualificationResult, QualificationUsage (+7 more)
...
Cohesion: 0.18
Nodes (14): evaluate(), observe(), png_valid(), ApiResult, AppContext, Outcome, Result, String (+6 more)
...
Cohesion: 0.39
Nodes (10): conflict(), apply(), bump(), link_import(), ApiResult, AppContext, ConnectionTrait, Option (+2 more)
...
Cohesion: 0.26
Nodes (6): CaseSelection, ExecutionBudget, PlanDefinition, Result, TestDefinition, validate_selections()
...
Cohesion: 0.31
Nodes (9): decode(), hash(), json(), ApiResult, String, T, Value, word() (+1 more)
...
- **Why does `QualificationError` connect `Community 23` to `Community 35`, `Community 4`, `Community 6`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 19`, `Community 61`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Session` connect `Community 9` to `Community 0`, `Community 1`, `Community 43`, `Community 20`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `WorkerModelCapabilities` connect `Community 16` to `Community 0`, `Community 18`, `Community 6`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
