...
def install(archive_name, checksum, destination):
    ...
    with tempfile.TemporaryDirectory(dir=destination.parent) as tmp:
        ...
        urllib.request.urlretrieve("https://dl.google.com/android/repository/" + archive_name, archive)
        ...
        print(f"Installed {archive_name}; SHA-256 {hashlib.sha256(archive.read_bytes()).hexdigest()}")
...
def main():
    ...
    install("platform-35_r02.zip", "0bb560a90a7a2cbd0dd8348224d518b638fe7949", sdk / "platforms/android-35")
